...
Default behavior:
- exact_track      -> BST, IC, MA, KME, HYBRID
- heuristic_track  -> MA, KME, HYBRID
...
EXACT_ALGOS = ["BST", "IC", "MA", "KME", "HYBRID"]
HEURISTIC_ALGOS = ["MA", "KME", "HYBRID"]
...
def main() -> None:
    ...
    parser.add_argument("--pop", type=int, default=50, help="Population size for MA/KME/HYBRID")
    parser.add_argument("--gens", type=int, default=200, help="Max generations for MA/KME/HYBRID")
