...
\begin{frame}{Why This Three-Algorithm Combination?}
	...
	\begin{block}{Complementary Research}
		\footnotesize
		\begin{itemize}
			\item \textbf{Standalone:} Each algorithm offers unique research directions
			\item \textbf{Pairwise:} IC vs K+BST (exact methods), IC vs GA (quality-time tradeoff)
			\item \textbf{Hybrid:} Kernelize $\rightarrow$ IC (best exact), Kernelize $\rightarrow$ GA (best approx)
			\item \textbf{Comprehensive:} First extensive comparison of these three approaches
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{Expected Research Contributions}
	\begin{block}{Potential Publications (3-5 Papers)}
		\footnotesize
		\textbf{1. Comprehensive Benchmark Study}
		\begin{itemize}
			\scriptsize
			\item Venue: SEA (Symposium on Experimental Algorithms) or ACM JEA
			\item Contribution: Largest benchmark (1,200+ instances), systematic comparison
			\item Impact: Medium-High (experimental paper)
		\end{itemize}
		
		\vspace{0.1cm}
		\textbf{2. Hybrid Exact-Metaheuristic Algorithms}
		\begin{itemize}
			\scriptsize
			\item Venue: GECCO or EvoCOP
			\item Contribution: Novel IC-GA hybrid, kernelization as preprocessing
			\item Impact: High (novel approach)
		\end{itemize}
		
		\vspace{0.1cm}
		\textbf{3. Problem-Specific Genetic Operators}
		\begin{itemize}
			\scriptsize
			\item Venue: PPSN or IEEE CEC
			\item Contribution: Cycle-aware crossover, theoretical analysis
			\item Impact: Medium-High (EA contribution)
		\end{itemize}
		
		\vspace{0.1cm}
		\textbf{4. New Reduction Rules} (if discovered)
		\begin{itemize}
			\scriptsize
			\item Venue: IPEC or Algorithmica
			\item Contribution: Novel reduction rules, improved kernel bounds
			\item Impact: Very High (theoretical)
		\end{itemize}
		...
		\begin{itemize}
			\scriptsize
			\item Venue: AAAI/IJCAI or NeurIPS workshop
			\item Contribution: ML for algorithm selection, feature engineering
			\item Impact: High (interdisciplinary)
		\end{itemize}
	\end{block}
\end{frame}

\begin{frame}{Success Metrics and Deliverables}
	\begin{columns}[T]
		\column{0.48\textwidth}
		\textbf{Technical Metrics:}
		\begin{itemize}
			\footnotesize
			\item \textbf{Correctness:} 100\% valid solutions
			\item \textbf{IC Performance:} Solve $k \leq 25$ in $< 60$s
			\item \textbf{GA Performance:} Within 10\% optimal for $n=1000$
			\item \textbf{Kernel Reduction:} 50\%+ on average
		\end{itemize}
		
		\vspace{0.3cm}
		
		\textbf{Research Metrics:}
		\begin{itemize}
			\footnotesize
			\item Novel insights discovered
			\item Paper draft quality
			\item Comparison comprehensiveness
		...
		\begin{enumerate}
			\footnotesize
			\item Three working implementations
			\item Comprehensive test suite
			\item 1,200+ benchmark instances
			\item Experimental results \& analysis
			\item Statistical validation
			\item Code documentation
			\item Final presentation
			\item 1+ paper draft (optional)
		\end{enumerate}
		
		\vspace{0.3cm}
		
		\begin{alertblock}{Minimum Success}
			\scriptsize
			2 algorithms + basic experiments = Pass\\
			3 algorithms + comprehensive = High Grade\\
			3 optimized + novel contributions = Publication
		\end{alertblock}
	\end{columns}
\end{frame}
