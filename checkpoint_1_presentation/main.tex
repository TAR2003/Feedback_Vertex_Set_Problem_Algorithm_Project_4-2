...
\author{2005090 - Tawkir Aziz Rahman \\
	...
	\begin{enumerate}
		...
		\item \textbf{Parameterized Complexity:} Fixed-Parameter Tractable (FPT)
		      \begin{itemize}
				...
				\item One of the best known FPT algorithms runs in time $O(c^k\cdot\text{poly}(n))$ for some $c<4$.
		      \end{itemize}

		      \vspace{0.2cm}
		\item \textbf{Bounds:}
		      \begin{itemize}
				\item A commonly used heuristic lower bound is $|E| - |V| + c$ (where $c$ = connected components)
